...
local f=game:GetService("HttpService");
 ...
 local GameLoadGuis = Instance.new("Message",workspace)
 GameLoadGuis.Text = 'Loading User Interface.'
 ...
 local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/Aoldemort/Uria/Library/l"))()
 local themeManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/Aoldemort/Uria/Library/t"))()
 local metadata = loadstring(game:HttpGet("https://raw.githubusercontent.com/Aoldemort/Uria/Library/metadata.lua"))()
 ...
 local Window = Library:CreateWindow({
	 Title = string.format(("Uria Hub Box Food Ultra Pro Max - "..tostring(h))),
	 AutoShow = false,
	 TabPadding = 5,
	 MenuFadeTime = 0,
	 Center = true,
...
if v:FindFirstChild('NameEsp') and not_G.ChestEsp then
v:FindFirstChild('NameEsp'):Destroy()
end
end
end
...
if v.Handle:FindFirstChild('NameEsp') and not_G.DFEsp then
	...
	if _G.Settings.Configs["Bypass TP"] then
	   if Distance > 3000 and not game:GetService("Players").LocalPlayer.PlayerGui.Main.InCombat.Visible == true then
		  ...
		  local tweenw, err = pcall(function()
			  if game:GetService("Players").LocalPlayer:DistanceFromCharacter(RealTarget.Position) <= 250 then 
			  ...
			  local function RemoveX() -- teleport player to part
	  ...
	  if (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-RealTarget.Position).Magnitude >= 150 and(game.Players.LocalPlayer.Character.HumanoidRootPart.Position-RealTarget.Position).Magnitude < 300 then 
		  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = RealTarget
		  game.Players.LocalPlayer.Character.Root.CFrame = RealTarget
	  elseif (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-RealTarget.Position).Magnitude < 150 then 
		  game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = RealTarget
		  game.Players.LocalPlayer.Character.Root.CFrame = RealTarget
	  end
		  end)
	   ...
	   local function toTargetautofarm(...)
		local RealtargetPos = {...}
		local targetPos = RealtargetPos[1]
		local RealTarget
		if type(targetPos) == "vector" then
...
-- World 1
if v.Name == "The Gorilla King [Lv. 25] [Boss]" and game.Players.localPlayer.Data.Level.Value >= 20then
_G.Settings.Boss["Select Boss"] = "The Gorilla King [Lv. 25] [Boss]"
elseif v.Name == "Bobby [Lv. 55] [Boss]" and game.Players.localPlayer.Data.Level.Value >= 55then
_G.Settings.Boss["Select Boss"] = "Bobby [Lv. 55] [Boss]" 
elseif v.Name == "Yeti [Lv. 110] [Boss]" and game.Players.localPlayer.Data.Level.Value >= 105then
...
elseif v.Name == "Magma Admiral [Lv. 350] [Boss]" and game.Players.localPlayer.Data.Level.Value >= 350then
_G.Settings.Boss["Select Boss"] = "Magma Admiral [Lv. 350] [Boss]"
elseif v.Name == "Fishman Lord [Lv. 425] [Boss]" and game.Players.localPlayer.Data.Level.Value >= 425then
...
elseif v.Name == "Fajita [Lv. 925] [Boss]" and game.Players.localPlayer.Data.Level.Value >= 925then
...
elseif v.Name == "Awakened Ice Admiral [Lv. 1400] [Boss]" and game.Players.localPlayer.Data.Level.Value >= 1400then
_G.Settings.Boss["Select Boss"] = "Awakened Ice Admiral [Lv. 1400] [Boss]"
elseif v.Name == "Tide Keeper [Lv. 1475] [Boss]" and game.Players.localPlayer.Data.Level.Value >= 1475then
...
Mainautofram:AddLabel("Misceallaneous ",true)
...
Mainautofram:AddLabel("Fighting Style",true)
...
toTarget(game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame)
 ...
 Msg:AddToggle('Auto_Farm_Race_V4', {
...
game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame * CFrame.new(0, 15, 0)
 ...
 repeat wait()
FarmtoTarget = toTarget(v.HumanoidRootPart.Position,v.HumanoidRootPart.CFrame *CFrame.new(0, _G.Settings.Configs["Distance Auto Farm"], 0))
if v:FindFirstChild("HumanoidRootPart") and v:FindFirstChild("Humanoid") and (v.HumanoidRootPart.Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).magnitude <= 150 then
if FarmtoTarget then FarmtoTarget:Stop() end
StartMagnet = true
PosMon = v.HumanoidRootPart.CFrame
...
toTarget(CFrame.new(85.4933853, 24.7600632, -12072.5273, 0.6147964, 7.9180019e-08, -0.788685858, -3.99571682e-08, 1, 6.92474629e-08, 0.788685858, -1.1059436e-08, 0.6147964))
elseif _G.Select_Island == "Candy Cane Island" then
toTarget(CFrame.new(-1080.17126, 14.6404228, -14481.4912, 0.997846127, 0, 0.0655979812, 0, 1, 0, -0.0655979812, 0, 0.997846127))
end
end)
...
local SaveManager = {} do
    ...
    function SaveManager:Save()
        local fullPath = ("Uria Hub/BF_"..game:GetService("Players").LocalPlayer.Name..".cfg")
	...
	if not isfolder("Uria Hub")then 
		makefolder("Uria Hub");
	end;
	if not isfile("Uria Hub/BF_"..game:GetService("Players").LocalPlayer.Name..".cfg")then 
		writefile("Uria Hub/BF_"..game:GetService("Players").LocalPlayer.Name..".cfg","[]");
	end;
    function SaveManager:Load()
        local file = ("Uria Hub/BF_"..game:GetService("Players").LocalPlayer.Name..".cfg")
        if not isfile(file) then return false, 'invalid file' end

        local success, decoded = pcall(httpService.JSONDecode, httpService, readfile("Uria Hub/BF_"..game:GetService("Players").LocalPlayer.Name..".cfg"))
    ...
    function SaveManager.Refresh()
        local list = listfiles('Uria Hub/Blox Fruits/')
    ...
    function SaveManager:Delete(name)
        local file = 'Uria Hub/Blox Fruits/' .. name .. '.cfg'
...
local Creditsg = Tabs['Miscellaneous']:AddRightTabbox()
...
local Miscg = Tabs['Miscellaneous']:AddRightTabbox()
...
addRichText(Misc:AddLabel(metadata.message or 'no message found!'))
    ...
    Misc:AddButton('Copy discord', function()
        if pcall(setclipboard, "discord.gg/QEsMnVz7TY") then
...
do
    ...
    themeManager:SetFolder('Uria Hub')
...
_G.Current_Time="N/A";
Library:SetWatermark(("Uria Hub Free Scripts | %s"):format(_G.Current_Time));
task.spawn(function()
    while true do wait();
        pcall(function()
...
elseifgame:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("ProQuestProgress","RichSon") == 0 then
...
if _G.Settings.Main["Auto Farm Level"] and (MyLevel >= 1 and MyLevel <= 300) then
if _G.Settings.Configs["Auto Haki"] then
if not game.Players.LocalPlayer.Character:FindFirstChild("HasBuso") then
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buso")
end
...
if MyLevel >= 1 and MyLevel <= 70 then
...
repeat wait()
 FarmtoTarget = toTargetautofarm(v.HumanoidRootPart.CFrame *CFrame.new(0, _G.Settings.Configs["Distance Auto Farm"], 0))
...
Modstween = toTargetautofarm(CFrameMon)
...
elseif MyLevel >= 50 and MyLevel <= 300 then
...
game:service('VirtualInputManager'):SendKeyEvent(false, "V", false, game)
 ...
 toTargetautofarm(v.HumanoidRootPart.CFrame *CFrame.new(0, _G.Settings.Configs["Distance Auto Farm"], 0))
 Fast = true
 EquipWeapon(_G.Settings.Configs["Select Weapon"])
end
...
FarmtoTarget = toTargetautofarm(v.HumanoidRootPart.CFrame)
...
toTargetautofarm(v.HumanoidRootPart.CFrame *CFrame.new(0, 1, 5))
EquipWeapon(_G.Settings.Configs["Select Weapon"])
Fast=true
wait(.1)
game:service('VirtualInputManager'):SendKeyEvent(true, "Z", false, game)
...
StartMagnet = false
Fast = false
Questtween = toTargetautofarm(CFrameQuest.Position,CFrameQuest)
if World1 and (Name == "Fishman Commando [Lv. 400]" or Name == "Fishman Warrior [Lv. 375]") and (CFrameQuest.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 50000 then
if Questtween then Questtween:Stop() end wait(.5)
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(61163.8515625, 11.6796875, 1819.7841796875))
elseif World1 and not (Name == "Fishman Commando [Lv. 400]" or Name == "Fishman Warrior [Lv. 375]") and (CFrameQuest.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 50000 then
...
Modstween = toTargetautofarm(CFrameMon.Position,CFrameMon)
if World1 and (Name == "Fishman Commando [Lv. 400]" or Name == "Fishman Warrior [Lv. 375]") and (CFrameQuest.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 50000 then
 if Modstween then Modstween:Stop() end wait(.5)
 game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("requestEntrance",Vector3.new(61163.8515625, 11.6796875, 1819.7841796875))
elseif World1 and not (Name == "Fishman Commando [Lv. 400]" or Name == "Fishman Warrior [Lv. 375]") and (CFrameQuest.Position - game:GetService("Players").LocalPlayer.Character:WaitForChild("HumanoidRootPart").Position).magnitude > 50000 then
...
if game.Players.LocalPlayer.Backpack:FindFirstChild("Banana") andgame.Players.LocalPlayer.Backpack:FindFirstChild("Apple") and game.Players.LocalPlayer.Backpack:FindFirstChild("Pineapple") then
repeat 
toTarget(CFrame.new(-12444.78515625, 332.40396118164, -7673.1806640625)) 
wait() 
until not _G.Settings.Main["Auto Ken-Haki V2"] or (game.Players.LocalPlayer.Character.HumanoidRootPart.Position-Vector3.new(-12444.78515625, 332.40396118164, -7673.1806640625)).Magnitude <= 10
...
elseif game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Container.QuestTitle.Title.Text =="DefeatCaptain Elephant (0/1)" then 
if game:GetService("Workspace").Enemies:FindFirstChild("Captain Elephant [Lv. 1875] [Boss]") then
for i,v in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
if v.Name == "Captain Elephant [Lv. 1875] [Boss]" then
repeat wait()
...
v.Handle.CFrame = v.HumanoidRootPart.CFrame * CFrame.new(0,1,10)
wait()
...
if not Swamp then 
repeat wait() 
Tween(CFrame.new(-10141.462890625, 138.6524658203125, 5935.06298828125) *CFrame.new(0, _G.Settings.Configs["Distance Auto Farm"], 0))
...
until not v.Parent or v.Humanoid.Health <= 0 or notv:FindFirstChild('HumanoidRootPart') or not v:FindFirstChild('Humanoid') or not _G.Settings.Main["Auto Quest Soul Guitar"]
...
wait(1)
if Swamp andGravestones and not Ghost then 
__CommF:InvokeServer("GuitarPuzzleProgress", "Ghost");
end 
wait(1)
ifSwamp andGravestones and Ghost and not Trophies then 
__CommF:InvokeServer("GuitarPuzzleProgress", "Trophies");
end
wait(1)
ifSwamp andGravestones and Ghost and Trophies and not Pipes then 
...
if game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate") and game.Players.LocalPlayer.Backpack:FindFirstChild("Fishman Karate").Level.Value >= 300then
local args = {
[1] = "BlackbeardReward",
[2] = "DragonClaw",
[3] = "2"
...
if game.Players.LocalPlayer.Character:FindFirstChild("Fishman Karate") and game.Players.LocalPlayer.Character:FindFirstChild("Fishman Karate").Level.Value >= 300then
local args = {
[1] = "BlackbeardReward",
[2] = "DragonClaw",
[3] = "2"
...
toTarget(game.ReplicatedStorage:FindFirstChild("Fajita [Lv. 925] [Boss]").HumanoidRootPart.CFrame*CFrame.Angles(math.rad(-90), 0, 0) * CFrame.new(0,0,_G.Settings.Configs["Distance Auto Farm"]))
...
toTarget(game.ReplicatedStorage:FindFirstChild("Jeremy [Lv. 850] [Boss]").HumanoidRootPart.CFrame*CFrame.Angles(math.rad(-90), 0, 0) * CFrame.new(0,0,_G.Settings.Configs["Distance Auto Farm"]))
...
toTarget(game.ReplicatedStorage:FindFirstChild("Diamond [Lv. 750] [Boss]").HumanoidRootPart.CFrame*CFrame.Angles(math.rad(-90), 0, 0) * CFrame.new(0,0,_G.Settings.Configs["Distance Auto Farm"]))
end
end
...
if_G.Settings.Stat["Select Stats"] == "Melee" then
local args = {
[1] = "AddPoint",
[2] = "Melee",
...
if L.Teleport_To_Mirage_Island.Value or L.Auto_Farm_Chest.Value or L.Auto_Factory.Value or L.Auto_Soul_Guitar.Value or L.Auto_Castle_Raid.Value or L.Auto_Complete_Trial.Value or L.Auto_Death_Step.Value or L.Auto_Ancientone_Quest.Value or L.Auto_SharkMan_Karate.Value or L.Auto_Kill_Elite_Hunter.Value or L.Auto_Electric_Claw.Value or L.Auto_Dough_V2.Value or L.Auto_Farm_Level.Value or L.Auto_Ectoplasm.Value or L.Auto_Evo_Race_Sky.Value or L.Auto_Superhuman.Value or L.Auto_Cake_Prince.Value or L.Auto_God_Human.Value or L.Auto_Teleport_to_Sea_Beast.Value or L.TryLuck.Value or L.Auto_Third_World.Value or L.Auto_Farm_Law_Dungeon.Value or L.Teleport_To_Gear.Value or L.Auto_Cursed_Dual_Katanaa.Value or L.Auto_Farm_Bone.Value or L.Auto_Farm_Gun_Mastery.Value or L.Auto_Rainbow_Haki.Value or L.Auto_Musketeer_Hat.Value or L.Auto_Farm_Fruit_Mastery.Value or L.Auto_Pull_Lever.Value or L.Auto_Evo_Race_FishMan.Value or L.Auto_Farm_Boss_Hallow.Value or L.Auto_Farm_Materia.Value or L.Auto_Dragon_Talon.Value or L.Teleport_to_Player.Valueor L.Auto_New_World.Valueor L.Auto_Pole.Valueor L.Auto_Farm_Boss.Valueor L.Auto_Swan_Glasses.Valueor L.Auto_Evo_Race_Human.Valueor L.Auto_Farm_All_Boss.Valueor L.Auto_Farm_Bounty.Valueor L.Auto_Holy_Torch.Valueor L.Auto_Buddy_Swords.Valueor L.Auto_Farm_Race_V4.Valueor L.Teleport_To_Trial_Door.Valueor L.Auto_Rengoku.Valueor L.Teleport_To_Island.Valueor L.Pray.Valueor L.Auto_Saber.Value and game:GetService("Players").LocalPlayer.Character:WaitForChild("Humanoid").Health > 0 then
pcall(function()
local args = {
[1] = "Ken",
[2] = true
...
i.Character.Humanoid.Sit=false;
...
if game.GameId == 994732206 then Kuy() end
