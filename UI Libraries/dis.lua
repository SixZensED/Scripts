	...
	function ServerHold:Server(text, img)
		...
		function ChannelHold:Channel(text)
			...
			function ChannelContent:MultiDropdown(text, list, callback)
				...
				Dropdown.Size = UDim2.new(0, 403, 0, 50)
				...
				DropdownFrameOutline.Position = UDim2.new(0, 3.5, 0, 10)
				...
				DropdownFrame.Position = UDim2.new(0, 5.5, 0, 12)
				...
				DropdownFrameMainOutline.Position = UDim2.new(0, 3.5, 0, 44)
				...
				DropdownFrameMain.Position = UDim2.new(0, 5.5, 0, 48)
				...
				for i,itmename in next, list do
					...
					Icon.BorderColor3 = Color3.fromRGB(27, 42, 53)
					Icon.Position = UDim2.new(0, 350, 0, 7.5)
					...
					ItemText.Text = itmename

					Item.MouseEnter:Connect(function()
						ItemText.TextColor3 = Color3.fromRGB(255,255,255)
						Item.BackgroundTransparency = .35
					end)
					...
					Item.MouseButton1Click:Connect(function()
						...
						if tablefound(MultiDropdown,itmename) == false then 
							table.insert(MultiDropdown,itmename)
							Icon.ImageTransparency = 0
						else 
							for ine,va in pairs(MultiDropdown) do
								if va == itmename then
									MultiDropdown[ine] = nil
								end
							end
							Icon.ImageTransparency = 1
						end  
